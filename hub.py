...
def get_dir():
    r"""
    Get the Torch Hub cache directory used for storing downloaded weights & weights.
...
def set_dir(d):
    r"""
    Optionally set the Torch Hub directory used to save downloaded weights & weights.

    Args:
        d (string): path to a local folder to save downloaded weights & weights.
    """
    global _hub_dir
    _hub_dir = d
